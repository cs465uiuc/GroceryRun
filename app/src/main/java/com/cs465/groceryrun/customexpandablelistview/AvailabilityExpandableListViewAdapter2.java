...
public class AvailabilityExpandableListViewAdapter2 extends BaseExpandableListAdapter {

    private Context context;
    private ArrayList<String> headerList; //For dates
    private HashMap<String, ArrayList<Availability>> itemList;

    public AvailabilityExpandableListViewAdapter2(Context context, ArrayList<Availability> items) {
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if (view == null) {
            ...
            view = infalInflater.inflate(R.layout.expandable_listview_availability2, null);
        }

        ImageView childImage = (ImageView) view.findViewById(R.id.availability_icon);
        childImage.setImageResource(R.mipmap.icon_user);
        ...
        TextView childText5 = (TextView) view.findViewById(R.id.availability_person);
        childText5.setText(childPerson);
